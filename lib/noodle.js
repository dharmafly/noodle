...
// - cache/expire
//
// More info: docs/11. Usage as a Module.md #noodle events
// ------------------------------------------------------------
...
// 
// Takes in a query in the map notation, see:
// docs/4. Writing a Query.md #Mapping a query to familiar
// properties
//
...
// Log to console if debug is set to true in config.json

if (exports.config.debug) {
  require('./logger')(exports.events);
}

// Initialize caches and expose the results cache for the 
// different type modules (html, json etc) to cache result
